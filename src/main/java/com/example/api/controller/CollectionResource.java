...
@ApiModel(value = "Collection", description = "Collection of resources", parent = LinkedHashMap.class)
public class CollectionResource extends Link {

    public static final int DEFAULT_LIMIT = 25;

    @ApiModelProperty(value = "Collection URL",     position = 1) public String getHref() { return super.getHref(); }
    ...
    @ApiModelProperty(access = "whatever") public String getType() { return super.getType(); } // hidden=true is overwritten by Link
